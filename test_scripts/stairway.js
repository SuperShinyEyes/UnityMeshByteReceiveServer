...
function createStairs() {
	...
	var stepMesh;
	var singleStepTotalHeight = stepThickness + verticalStepHeight;
    var zPadding = horizontalStepDepth - stepThickness;
    ...
    for ( var i = 0 ; i < 6; i++ ) {
        ...
        stepMesh.position.y = verticalStepHeight/2 + singleStepTotalHeight * i;	// half of height: put it above ground plane
        stepMesh.position.z = 0 + zPadding * i;			// centered at origin
        scene.add( stepMesh );
        ...
        stepMesh.position.y = stepThickness/2 + verticalStepHeight + singleStepTotalHeight * i;
        // Push step forward by half the depth, minus half the vertical step's thickness
        stepMesh.position.z = horizontalStepDepth/2 - stepHalfThickness + zPadding * i;
        scene.add( stepMesh );
    }
...
/**
 * Created by young on 02/05/2017.
 */
